...
Begin VB.Form DaftarBarangJual 
   ...
   End
End
Attribute VB_Name = "DaftarBarangJual"
...
Select Case KeyCode
    Case vbKeyEscape
        Unload Me
    Case vbKeyReturn
        Penjualan.TxtKodeBarang = DG.Columns(0)
        Penjualan.NamaBarang = DG.Columns(1)
        Penjualan.HargaJual = DG.Columns(3)
        Penjualan.TxtJumlah.SetFocus
        Unload Me
End Select
End Sub
